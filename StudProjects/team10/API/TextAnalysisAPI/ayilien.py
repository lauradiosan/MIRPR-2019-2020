...
query = 'I wish to go with my family in a warm place where my children can swim and where my husband can Gamble. Also ' \
        'I want this place to be in the United States. Somewhere in California should do the trick. The budget is ' \
        'around 10 thousand dollars and we want to go this summer. '

...
flags.DEFINE_string('weights_first_load', './custom_initial_weights/yolov3.tf',
                    'the path for loading the initial weights from a full model tiny')
flags.DEFINE_string('weights_first_load_tiny', './custom_initial_weights/yolov3-tiny.tf',
                    'the path for loading the initial weights from a full model tiny')
